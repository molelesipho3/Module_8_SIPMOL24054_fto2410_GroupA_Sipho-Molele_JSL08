...
//    - Use the `getBranchInfo` method to retrieve branch information from the instances.
       ...
       console.log(branchA.getBranchInfo()); // Output: "Cape Town Branch"

       const branchB = new BankBranch("Johannesburg Branch");
       console.log(branchB.getBranchInfo()); // Output: "Cape Town Branch" (Singleton pattern ensures only one instance)
